...
# # Tweaking plots
# 
# In this section we cover a couple of points about adjusting the appearance of plots
# 
# ## <tt>Matplotlib</tt>
# 
...
# 
# In the olden days, people made plots just with <tt>Matplotlib</tt> and had to write a lot ore code to achieve a nice looking plot.
# 
...
# 
# This is achieved using the function <tt>plt.subbplot</tt> which creates... a figure with multiple panels or subplots.
...
# 
# Can you change the code in the block below to organize the panels one abbove the other, rather than next to each other?
...
# ### Set axis labels
# 
# Your axis labbels should always convey what is plotted. If you are using <tt>Seaborn</tt> with a <tt>Pandas</tt> dataframe, the axis labels will often be the column labels from your dataframe, which are (usually) meaningful although sometimes they are odd codes that wouldn't mean much to a naive reader (Pclass anyone? SibSp? Parch?).
# 
