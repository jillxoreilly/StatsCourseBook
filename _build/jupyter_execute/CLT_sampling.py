...
# As we saw in the lecture, the standard deviation of the sampling distribution of the mean, which is also known as the <i>standard error of the mean</i> or SEM, is given by the formula:
# 
